...
set SRCS="MaidVoicePitchPlugin.cs" "DebugLineRender.cs" "FaceScripteTemplates.cs" "KagHooks.cs" "SliderTemplates.cs" "TBodyMoveHeadAndEyeReplcacement.cs" "TemplateFiles.cs" "%OKIBA_LIB%\Helper.cs" "%OKIBA_LIB%\PluginHelper.cs"
